...
namespace VanillaParagons.SupportParagons.VillageParagon
{
    ...
    public class VillageParagon : ModParagonUpgrade<VillageParagonBase>
    {
        ...
        {
            tower.AddBehavior(new RangeSupportModel("GodBoostingRange", true, 0, 25, "RangeMutator", null, false, "EnderGodBoost", "BuffIconTempleSunGod4xx"));
            tower.AddBehavior(new RateSupportModel("GodBoostingAttackSpeed", .045f, true, "AttackSpeedMutator", false, 0, null, "EnderGodBoost", "BuffIconTempleSunGod4xx"));
            tower.AddBehavior(new DamageSupportModel("GodBoostingDamage", true, 36, "DamageMutator", null, false, false, 0.0f));
            tower.AddBehavior(new PierceSupportModel("GodBoostingPierce", true, 185, "PierceMutator", null, false, "EnderGodBoost", "BuffIconTempleSunGod4xx"));
            ...
            weapon.projectile.GetDamageModel().damage = 150;
            weapon.projectile.pierce = 20000;
        }
    }
}